    ...
    class Program
    {
        static void Main(string[] args)
        {
            var user = new SampleUser
            {
                ...
                Username = "rjones@qsrautomations.com",
                Password = "Kaylee1975!",
                Subdomain = "qsr"
            };

            string oauthClientId = "eLRzQwFhzILw8WdJFFgQ3GMUB0zhSbGk";
            string oauthClientSecret = "25gtQWH4ybHra1z3AUk1oL8Ox8COzWrsAYpbV0YaTeA3Xsfd";
        ...
        public static async Task RunSample(SampleUser user, string clientId, string clientSecret)
        {
            ...
            string recipientEmailAddress = "rjones@qsrautomations.com";
